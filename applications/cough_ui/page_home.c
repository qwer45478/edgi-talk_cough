...
void page_home_create(lv_obj_t *parent)
{
    ...
    /* щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ 1. Chart card щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ */
    ...
    /* щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ 2. Level-bar card щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ */
    ...
    /* щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ 3. Three-column info: Cough | Day/Night | Env щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖щ??ц?дц?╖ */
